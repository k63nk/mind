...
interface LoginPageProps {
  onBack: () => void;
  onLoginSuccess: (role: 'student' | 'business') => void;
}
      ...
      <div className="w-full max-w-[480px] relative z-10 flex flex-col items-center">
        ...
        <div className="login-card w-full p-8 md:p-10 rounded-[2.5rem] border border-white/10 shadow-2xl">
          ...
          <button 
            ...
            className="w-full py-4 px-6 bg-white text-black font-bold rounded-2xl flex items-center justify-center gap-3 hover:bg-slate-100 transition-all mb-8 shadow-md"
          >
          ...
          <div className="relative mb-8 text-center">
            ...
            <span className="relative px-4 text-xs font-bold text-slate-500 bg-[#121212] uppercase tracking-widest">Hoặc đăng nhập với Email</span>
          </div>

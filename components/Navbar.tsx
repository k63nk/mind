    ...
    <nav className="fixed top-0 w-full z-50 nav-blur border-b border-slate-200 dark:border-white/10">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="px-6 py-2.5 bg-gradient-to-r from-primary to-secondary text-white text-sm font-bold rounded-full hover:shadow-lg hover:shadow-primary/20 transition-all">Đăng ký</button>
        </div>
      </div>
    </nav>
  );

        ...
        <div className="p-8 space-y-8 max-w-[1400px] mx-auto">
          <section className="bg-[#111821] p-10 rounded-[2.5rem] border border-slate-800 shadow-2xl">
             ...
             <div className="flex flex-wrap gap-3">
               ...
               <span className="px-4 py-2 bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 rounded-xl text-xs font-bold uppercase tracking-widest">Problem Solving</span>
             </div>

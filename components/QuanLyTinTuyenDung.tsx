          ...
          <div className="flex flex-col gap-8 max-w-[1400px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 rounded-2xl bg-[#1e293b] border border-[#334155] shadow-xl">
                ...
                <p className="text-4xl font-black text-white italic">135</p>
              ...
              <div className="p-6 rounded-2xl bg-[#1e293b] border border-[#334155] shadow-xl">
                ...
                <p className="text-4xl font-black text-white italic">35.5%</p>
                <p className="text-[10px] text-slate-500 font-black uppercase tracking-widest mt-2">Dựa trên 48 hồ sơ đã duyệt</p>
              </div>
              <div className="p-6 rounded-2xl bg-[#1e293b] border border-[#334155] shadow-xl">
                <div className="flex items-center justify-between mb-3">
                ...
                <p className="text-4xl font-black text-white italic">02</p>
                <p className="text-[10px] text-slate-500 font-black uppercase tracking-widest mt-2">Trên tổng số 12 chiến dịch</p>
              </div>
            </div>
          </div>
        </div>

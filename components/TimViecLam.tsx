          ...
          <section className="mb-10 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 bg-[#111821] p-4 rounded-2xl shadow-xl border border-slate-800">
              <div className="relative group">
                <label className="block text-xs font-semibold text-slate-400 mb-1 ml-1">ĐỊA ĐIỂM</label>
                <div className="flex items-center gap-2 px-3 py-2 bg-slate-900/50 rounded-xl border border-transparent group-hover:border-[#1392ec]/50 transition-all cursor-pointer">
                  <span className="material-icons-round text-slate-400 text-sm">location_on</span>
                  <span className="text-sm flex-grow text-slate-200">Tất cả địa điểm</span>
                  <span className="material-icons-round text-slate-400 text-sm">expand_more</span>
                </div>
              </div>
              <div className="relative group">
                <label className="block text-xs font-semibold text-slate-400 mb-1 ml-1">NGÀNH NGHỀ</label>
                <div className="flex items-center gap-2 px-3 py-2 bg-slate-900/50 rounded-xl border border-transparent group-hover:border-[#1392ec]/50 transition-all cursor-pointer">
                  <span className="material-icons-round text-slate-400 text-sm">work_outline</span>
                  <span className="text-sm flex-grow text-slate-200">Công nghệ thông tin</span>
                  <span className="material-icons-round text-slate-400 text-sm">expand_more</span>
                </div>
              </div>
              <div className="relative group">
                <label className="block text-xs font-semibold text-slate-400 mb-1 ml-1">MỨC LƯƠNG</label>
                <div className="flex items-center gap-2 px-3 py-2 bg-slate-900/50 rounded-xl border border-transparent group-hover:border-[#1392ec]/50 transition-all cursor-pointer">
                  <span className="material-icons-round text-slate-400 text-sm">payments</span>
                  <span className="text-sm flex-grow text-slate-200">Trên 15 triệu</span>
                  <span className="material-icons-round text-slate-400 text-sm">expand_more</span>
                </div>
              </div>
              <div className="relative group">
                <label className="block text-xs font-semibold text-slate-400 mb-1 ml-1">KỸ NĂNG</label>
                <div className="flex items-center gap-2 px-3 py-2 bg-slate-900/50 rounded-xl border border-transparent group-hover:border-[#1392ec]/50 transition-all cursor-pointer">
                  <span className="material-icons-round text-slate-400 text-sm">psychology</span>
                  <input className="bg-transparent border-none focus:ring-0 text-sm w-full p-0 text-slate-200 placeholder-slate-500" placeholder="Tìm theo kỹ năng..." type="text"/>
                </div>
              </div>
            </div>
